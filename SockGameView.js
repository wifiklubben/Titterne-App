      ...
      >
        ...
        >
          ...
          {clearedCards.length === 12 && (
            ...
            <Emitter numberOfParticles={25} emissionRate={5} interval={0} particleLife={2000} direction={90} spread={360} speed={100} width={300} gravity={20} fromPosition={{ x: 240, y: 240 }}>
